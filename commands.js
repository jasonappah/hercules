...
window.FakeTerminal.command.play = function (instance) {
    ...
    base.execute = function () {
        ...
        instance.input.request().done(function(value) {
            ...
            write("Eurystheus: The gods and I would like you to complete a few tasks.", instance)
            buttonThing(["Hercules: Why me?", "Hercules: No.", "Hercules: Fine. Let's just get this over with."])
            instance.input.request().done(function(value) {
                write(actions[value]["label"], instance)
            })
